  ...
  return (
    <section className="py-12 text-center flex flex-col items-center bg-purple-900 relative md:bg-purple-700 md:text-start">
      ...
      <div className="z-10 mt-16 sm:w-[80%] sm:max-w-4xl">
        <img className="w-full" src="/images/mobile/macbook.png" alt="Mackbook" />
      </div>
      <img className="absolute left-0 bottom-0 z-0 md:right-0 md:top-0 md:left-auto md:rotate-180" src="/images/mobile/feature4-circle.png" alt="" />
    </section>
  );
}
